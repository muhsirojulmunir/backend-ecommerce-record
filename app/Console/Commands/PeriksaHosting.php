...
class PeriksaHosting extends Command
{
    ...
    private const TABEL_WAJIB = [
        ...
        'products'           => 'produk',
        'roles'              => 'peran (Spatie Permission)',
        'permissions'        => 'izin (Spatie Permission)',
        'model_has_roles'    => 'kaitan peran ke pengguna',
    ];

    /** Tabel dari fitur yang ditambahkan belakangan. */
    private const TABEL_FITUR = [
        'biteship_saldo'  => 'pencatatan saldo Biteship',
        'order_exports'   => 'riwayat ekspor pesanan',
