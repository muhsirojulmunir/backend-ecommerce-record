 ...
 * 2. Pembayaran manual (Transfer Bank / BCA / dsb) yang belum dibayar dan belum mengunggah bukti transfer.
 *
 * Efek:
            ...
            try {
                DB::transaction(function () use ($order, $hours) {
                    $order->update([
                        ...
                        'cancellation_note'   => "Sistem otomatis membatalkan pesanan karena telah melewati batas waktu pembayaran {$hours} jam.",
                        'cancelled_at'        => now(),
                    ]);
